...
def reporte_compras(request):
    ...
    response['Content-Disposition'] = 'inline; filename="report.pdf"' #Al poner attachment en vez de inline se va a descargar el archivo en ves de presentar la compra
    # Tomar la plantilla y renderizarla
    template = get_template(template_path)
    html = template.render(context)

    # Crear un pdf__revisar documentacion (xhtml2pdf)
