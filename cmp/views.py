...
def proveedorInactivar(request, id):
    ...
    if request.method=='GET': #Si se esta mandando a llamar la vista se inicializara contexto con obj y a obj se le asigna la consulta que se haya enviado a la BD via ORM de DJango
        contexto={'obj':prv}
    ...
    if request.method=='POST':
        ...
        if not compra_id:
            ...
            if enc:
                ...
                enc.usuarioModifica=request.user.id
                enc.save()
