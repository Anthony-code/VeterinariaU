...
class SubCategoriaNew(SuccessMessageMixin,SinPrivilegios,\
    generic.CreateView):
...
class SubCategoriaEdit(SuccessMessageMixin,SinPrivilegios,\
    generic.UpdateView):
...
class SubCategoriaDel(SuccessMessageMixin,SinPrivilegios,\
    generic.DeleteView):
