...
class SubCategoriaForm(forms.ModelForm):
    categoria = forms.ModelChoiceField(
        queryset=Categoria.objects.filter(estado=True) #Consulta para mostrar las categorias con estado True#
...
class ProductoForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        #El elemento html que va a mostrar para existencia y ultima comra no van a poder ser editados por el usuario
